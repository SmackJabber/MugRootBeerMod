...
public class SassafrassPlankBlock extends Block {
	public SassafrassPlankBlock() {
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(MugRootbeerModBlocks.SASSAFRASS_PLANK, RenderType.solid());
	}
}
