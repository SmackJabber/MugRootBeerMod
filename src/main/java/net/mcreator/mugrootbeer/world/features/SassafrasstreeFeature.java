...
package net.mcreator.mugrootbeer.world.features;
...
public class SassafrasstreeFeature extends Feature<NoneFeatureConfiguration> {
	public static final SassafrasstreeFeature FEATURE = (SassafrasstreeFeature) new SassafrasstreeFeature();
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("mug_rootbeer", "soup"));
		if (template == null)
			return false;
